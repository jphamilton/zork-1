...
public class Give : Routine
{
    public Give()
    {
        ...
        Requires = [X.Animate, X.Held]; // e.g. give bear food
        Reverse = true;
        ImplicitObject = (X r) => r == X.Animate ? Player.Instance : Inventory.Count == 1 ? Inventory.Items[0] : null;
    }
